# Usage: >> python search_clustering_center_region.py --index index.csv --query queries/sample_query.jpg --result-path datacars --cluster 10
# or >> py search_clustering_center_region.py -i <your_index_filename> -q <your_query_image> -r <your_dataset> -c <number_of_cluster>
