# Usage: >> python search.py --index index.csv --query queries/sample_query.jpg --result-path datacars
# or >> py search.py -i <your_index_filename> -q <your_query_image> -r <your_dataset>
